...
public class EZDocProcedureTest {
    ...
    public void shouldPassTagCheck()
    {
        ...
        assertEquals(WordTag.Type.UNKNOWN, word.getTag().tag);       
    }
            ...
            throws FileNotFoundException
    {
        ...
        fosOutputStream = new FileOutputStream(new File("out1.txt"));
            ...
            throws FileNotFoundException
    {
        ...
        alWord          = new ArrayList<>();
        fosOutputStream = new FileOutputStream(new File("out2.txt"));
